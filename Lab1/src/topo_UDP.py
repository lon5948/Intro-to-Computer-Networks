...
if __name__ == '__main__':
    ...
    h3 = net.get("h3")
    h4 = net.get("h4")
    # Use udpdump to record packet in background
    ...
    # UDP flow
    h3.cmd("iperf -s -u -b 6M -i 1 -t 5 -p 7777 > ../out/UDP_s_h3.txt &")
    h2.cmd("iperf -c " + str(h3.IP()) + " -u -b 6M -i 1 -t 5 -p 7777 > ../out/UDP_c_h2.txt &")
    h4.cmd("iperf -s -u -b 6M -i 1 -t 5 -p 7777 > ../out/UDP_s_h4.txt &")
    h1.cmd("iperf -c " + str(h4.IP()) + " -u -b 6M -i 1 -t 5 -p 7777 > ../out/UDP_c_h1.txt &")
